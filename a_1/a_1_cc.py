...
def main():
    ...
    for degree_D in [100, 300, 500, 1000, 2000]:
        ...
        component_G = graphtools.subgraph(G, component)

        # Compute degree statistics
        if component:
            in_degree_stats, total_degree_stats = compute_degree_statistics(G, component)
